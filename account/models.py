...
class Account(AbstractBaseUser):
    ...
    task_earned        = models.IntegerField(default=0)
    tot_referer        = models.IntegerField(default=0)
...
class Withdrawal(models.Model):
   ...
   # withdrawl = models.CharField()
    account_name = models.OneToOneField(Account, on_delete=models.CASCADE)
